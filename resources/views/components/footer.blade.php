...
<footer class="bg-gray-900 text-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            ...
            <!-- Shop Links -->
            <div class="col-span-1 md:col-span-1 lg:col-span-1">
                <h4 class="text-base md:text-lg font-semibold mb-2 md:mb-4">SHOP</h4>
                <ul class="space-y-1 md:space-y-2">
                    @php
            ...
            <div class="col-span-2 md:col-span-2 lg:col-span-1">
                <h4 class="text-base md:text-lg font-semibold mb-2 md:mb-4">BRANDS</h4>
                <ul class="space-y-1 md:space-y-2">
                    @php
                    ...
                    @empty
                        <li class="text-gray-400 text-sm md:text-base">No brands available</li>
                    @endforelse
                    @if($brands->count() > 0)
                        <li>
